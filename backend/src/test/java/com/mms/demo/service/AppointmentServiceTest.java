...
// static final Patient patient = Patient.builder().age(25).email("temp@temp.com").gender("M")
// .name("Jerry").phone("XYZ").build();
// static final Slot slot = Slot.builder().start(LocalTime.of(0, 0, 0)).end(LocalTime.of(0, 0, 1))
// .weekday(DayOfWeek.MONDAY).capacity(5).build();
...
// assertThat(patientImpl.createPatient(tempPatient)).isEqualTo(tempPatient)
// .isNotEqualTo(patient);
