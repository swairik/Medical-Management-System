...
// report =
// Report.builder().contents(null).stamp(LocalDateTime.now().truncatedTo(ChronoUnit.SECONDS)).build();
...
// assertThat(impl.getAllReportsByStampBetween(temporalTarget,
// LocalDateTime.now())).containsAll(reports).doesNotContain(temp);
// }
