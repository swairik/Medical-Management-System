...
// // public ResponseEntity<SpecialityResponse> getSpecialityById(@PathVariable
// Long id) {
...
// SpecialityResponse.createResponseFromSpeciality(speciality);
// // return new ResponseEntity<>(response, HttpStatus.OK);
// // }
...
// // .filter((s) ->
// s.getName().equals(specialityRequest.getName())).findFirst()
// // .orElse(null);
...
// SpecialityRequest.createSpecialityFromRequest(specialityRequest);
// // Speciality createdSpeciality =
...
// // @PostMapping("/{id}")
// // public ResponseEntity<SpecialityResponse> udpateSpeciality(@PathVariable
// Long id,
// // @Valid @RequestBody SpecialityRequest specialityRequest) {
// // Speciality speciality =
// SpecialityRequest.createSpecialityFromRequest(specialityRequest);
// // Speciality updatedSpeciality = specialityService.updateSpeciality(id,
// speciality);
// // SpecialityResponse response =
