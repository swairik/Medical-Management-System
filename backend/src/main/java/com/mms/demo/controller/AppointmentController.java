...
// // .map((a) ->
// createResponseFromAppointment(a)).collect(Collectors.toList());
// // return new ResponseEntity<>(response, HttpStatus.OK);
// // }

// // @GetMapping("/display/{id}")
// // public ResponseEntity<AppointmentResponse>
// // displayAppointmentById(@PathVariable Long id) {
...
// // public ResponseEntity<List<AppointmentResponse>>
// // showUpcomingAppointmentsByDoctor(
// // @PathVariable Long id, @RequestParam String stamp) {
...
// scheduleService.getSchedulesBySlot(a.getSlot());
...
// // Slot slot = slotService.getSlotById(a.getSlot().getId())
// // .orElseThrow(() -> new CustomException("Slot with given id not found",
// // "SLOT_NOT_FOUND"));
...
// // public ResponseEntity<List<AppointmentResponse>>
// // showAllPatientUpcoming(@PathVariable Long id,
...
// // public ResponseEntity<List<AppointmentResponse>>
// // showAllPatientBetween(@PathVariable Long id,
...
// // "PATIENT_NOT_FOUND"));
// // List<Appointment> appointments =
// // appointmentService.getAllByPatientBetween(patient, startTime, endTime);
// // List<AppointmentResponse> response = appointments.stream()
// // .map((a) ->
// createResponseFromAppointment(a)).collect(Collectors.toList());
// // return new ResponseEntity<>(response, HttpStatus.OK);
...
// // public ResponseEntity<List<AppointmentResponse>>
// // showAllDoctorAppointmentBetween(
// // @PathVariable Long id, @RequestParam String start, @RequestParam String
// end)
// // {
// // DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy/MM/dd
// // HH:mm:ss");
...
// // return appointmentDateTime.isAfter(startTime) &&
...
// createAppointmentFromRequest(appointmentRequest);
...
// // Patient patient =
// // patientService.getPatientById(appointmentRequest.getPatientId())
// // .orElseThrow(() -> new CustomException(
// // "Patient with given id not found",
// // "PATIENT_NOT_FOUND"));
// // if (patient.getGender() == null || patient.getAge() == null
...
// // "Appointment with given patient id and slot id already created",
...
// // createResponseFromAppointment(createdAppointment);
// // return new ResponseEntity<>(response, HttpStatus.OK);
// // }

// // @PutMapping("/{id}")
// // public ResponseEntity<AppointmentResponse> updateAppointment(@PathVariable
// // Long id,
// // @Valid @RequestBody AppointmentRequest appointmentRequest,
// // @AuthenticationPrincipal Credential user) {
// // Appointment appointment = appointmentService.getAppointmentById(id)
...
// // appointmentService.updateAppointment(id, updateAppointment);
// // AppointmentResponse response =
// // createResponseFromAppointment(updatedAppointment);
// // return new ResponseEntity<>(response, HttpStatus.OK);
// // }
...
// // Integer maxCapacity = (int) slot.getStart().until(slot.getEnd(),
...
// // public AppointmentResponse createResponseFromAppointment(Appointment
// // appointment) {
...
// // }).collect(Collectors.toList());
// // if (filteredSchedules.size() == 0) {
// // throw new CustomException("Schedule does not exist",
// "SCHEDULE_NOT_FOUND");
// // }
// // ScheduleResponse scheduleResponse =
// // ScheduleResponse.createResponseFromSchedule(filteredSchedules.get(0));
// // AppointmentResponse appointmentResponse = AppointmentResponse.builder()
// // .id(appointment.getId()).patientResponse(patientResponse)
// // .scheduleResponse(scheduleResponse).attended(appointment.getAttended())
// // .build();
// // return appointmentResponse;
// // }

// // public Appointment createAppointmentFromRequest(AppointmentRequest
// // appointmentRequest) {
// // Patient patient =
// // patientService.getPatientById(appointmentRequest.getPatientId())
// // .orElseThrow(() -> new CustomException("Patient with given id not found",
...
// // }
// // Appointment appointment =
// // Appointment.builder().patient(patient).slot(slot).build();
// // return appointment;
// // }
