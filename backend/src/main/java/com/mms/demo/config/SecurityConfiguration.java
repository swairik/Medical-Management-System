...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeHttpRequests()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/doctor/**")
                        ...
                        .requestMatchers(HttpMethod.POST, "/slot/**")
                        .hasAnyAuthority("ADMIN", "DOCTOR")
                        .requestMatchers(HttpMethod.PUT, "/slot/**")
                        .hasAnyAuthority("ADMIN", "DOCTOR")
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/speciality/**")
                        .hasAnyAuthority("ADMIN")

                        .requestMatchers(HttpMethod.POST, "/prescription/**")
                        .hasAnyAuthority("ADMIN", "DOCTOR")
                        .requestMatchers(HttpMethod.PUT, "/prescription/**")
                        .hasAnyAuthority("ADMIN", "DOCTOR")
                        .requestMatchers(HttpMethod.DELETE, "/prescription/**")
                        .hasAnyAuthority("ADMIN", "DOCTOR")
